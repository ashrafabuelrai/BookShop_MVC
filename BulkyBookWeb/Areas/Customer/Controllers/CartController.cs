...
namespace BulkyBookWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            _emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "New Oredr - Bulk Book",
        ...
        {
            var cartDb = _unitOfWork.ShoppingCart.Get(s => s.Id == Id);
            cartDb.Count += 1;
        ...
        {
            var cartDb = _unitOfWork.ShoppingCart.Get(s => s.Id == Id, tracked: true);
            if (cartDb.Count <= 1)
            {
                HttpContext.Session.SetInt32(SD.SessionCart, _unitOfWork.ShoppingCart.GetAll(s => s.ApplicationUserId == cartDb.ApplicationUserId).Count() - 1);
